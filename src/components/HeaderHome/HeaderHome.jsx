...
export default function HeaderHome() {
    ...
    return (
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
            <NavLink className="navbar-brand" to={'/'}>ReactRouter</NavLink>
            ...
            <div className="collapse navbar-collapse" id="collapsibleNavId">
                <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li className="nav-item">
                        <NavLink exact activeClassName='bg-white text-dark' className="nav-link" to="/reactlifecycle">Life Cycle</NavLink>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownId">
                            ...
                            <NavLink className="dropdown-item" to="/usereducer">Use Reducer</NavLink>
